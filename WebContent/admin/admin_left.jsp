...
<ul>
	...
	<ul>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/BookAction.do?action=selectlist"
			target="main-frame">商品列表</a></li>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/admin/admin_addBook.jsp"
			target="main-frame">添加商品</a></li>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/BookClassAction.do?action=select"
	...
	<ul>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/UserAction.do?action=list"
	...
	<ul>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/OrderAction.do?action=listAll"
